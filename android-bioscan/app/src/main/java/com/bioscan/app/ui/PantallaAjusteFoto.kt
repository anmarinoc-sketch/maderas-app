...
private val Fondo = Color(0xFF0C1A15)
private val Panel = Color(0xFF1A2B24)
private val Verde = Color(0xFF6FBF73)
private val TextoTenue = Color(0xFFA9BFB4)

/** Lado minimo del recorte, en pixeles de pantalla, para que no se cierre sobre si mismo. */
private const val MINIMO = 80f

/**
 * Ajuste de la foto antes de identificarla: girar y recortar.
 *
 * Portado de XiloScan, donde ya esta rodado. La geometria es identica; solo cambian los
 * textos y la paleta.
 *
 * Recortar no es cosmetico. La foto se reduce a 1280 px de lado antes de subirla, asi
 * que si el ave ocupa un cuarto del encuadre se tiran tres cuartas partes de la
 * resolucion util antes de que el modelo la vea. Y ahi es donde se decide si acierta.
 */
@Composable
        ...
        Column(Modifier.fillMaxSize()) {
            ...
            Row(
                ...
                Column(Modifier.weight(1f)) {
                    ...
                    Text(
                        if (modoRecorte) {
                            "Arrastra las esquinas para dejar dentro solo la planta o el animal."
                        } else {
                            "Recorta para que se vea de cerca, y gira si hace falta."
                        },
                        color = TextoTenue,
            ...
            if (!modoRecorte) {
                Button(
                    ...
                    Text("Identificar esta foto", fontWeight = FontWeight.Bold)
                }
            }
