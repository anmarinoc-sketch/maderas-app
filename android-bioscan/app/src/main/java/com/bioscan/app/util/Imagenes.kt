...
/**
 * Preparacion de la foto antes de subirla. Tomado de XiloScan, donde ya esta rodado.
 *
 * La unica diferencia es el lado maximo: identificar una hoja o un ave se apoya en la
 * forma general y no en detalles de milimetros, asi que 1280 px sobran y hacen la
 * subida mas rapida con mala cobertura.
 */
object Imagenes {

    private const val LADO_MAX = 1280
